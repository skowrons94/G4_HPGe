...
private:
  ...
  enum {pgIsotropicGun, pgGammaDecayScheme, pgPositronGun, pgNuclideGun, pgUndefined,pgPrimaryGun} m_selectedPG = pgUndefined;
    ...
    shared_ptr<PrimaryGunGen> m_pgPrimaryGun;
